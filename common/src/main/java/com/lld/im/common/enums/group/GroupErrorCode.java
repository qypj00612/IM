...
public enum GroupErrorCode implements ApplicationExceptionEnum {
    ...
    GROUP_CREATE_ERROR(40019,"创建群失败"),

    GROUP_MEMBER_NULL(40020,"群成员不能为空"),

    DESTROY_ERROR(40021,"解散群失败"),

    PUBLIC_GROUP_CAN_NOT_ADD(40022,"公开群不允许拉人"),

    PERMISSION_ERROR(40023,"权限不足"),
    ...
    GroupErrorCode(int code, String desc){
        this.code = code;
        this.desc = desc;
    }
